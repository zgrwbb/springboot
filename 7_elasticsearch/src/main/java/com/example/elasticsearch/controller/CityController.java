...
public class CityController {
    ...
    public List<City> getCityByDescriptionAndScore(@RequestParam String description,
    ...
    public List<City> getCityByDescriptionOrScore(@RequestParam String description,
                                                  @RequestParam Integer score) {
